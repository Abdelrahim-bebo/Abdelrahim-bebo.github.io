...
import profilePic from "./assets/images/bebo.jpg"; // <- photo for "man working" section
import alexuLogo from "./assets/images/alexu_logo.png";
import itiLogo from "./assets/images/iti.jpeg";
import depiLogo from "./assets/images/depi_logo.png";
import pmsLogo from "./assets/images/pms_logo.png";
import kodekloudLogo from "./assets/images/kodekloud_logo.png";
import linuxImage from "./assets/images/Linux.jpg";
import pythonImage from "./assets/images/Python.png";
import heroImage from "./assets/images/bebo2.jpg"; // <- photo for the beginning (Greeting hero)
...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1x6bTuJAmfgYapCTNL8AeavbTfvTcGGiX/view?usp=drive_link", // Replace with your Google Drive resume link
  profilePic,
  heroImage,
...
const illustration = {
  animated: false,
  display: false, // <- disable left illustration column to make sections full-width
  imagePath: profilePic // <- forces "man working" illustration to use profilePic
};
